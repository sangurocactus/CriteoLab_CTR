# Model #4 - Gradient Boosted Trees, Full Data Set
...
print('DFs transformed for entry into GBT Model')
print('Train')
...
gbtClassifier = GBTClassifier(featuresCol = 'features', labelCol = 'Label', maxDepth = depth, stepSize=.10)
gbtModel = gbtClassifier.fit(toyDF_trans)
predictions = gbtModel.transform(miniValDF_trans)
